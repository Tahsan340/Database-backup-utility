...
INSERT INTO `backup_history` VALUES (1,'ecommerce_db','backups/ecommerce_db_20260619_095456.sql','2026-06-19 03:54:58','SUCCESS');
...
CREATE TABLE `carts_items` (
  ...
  KEY `cartitems_cart` (`cart_id`),
  KEY `cartitems_product` (`product_id`),
  CONSTRAINT `cartitems_cart` FOREIGN KEY (`cart_id`) REFERENCES `carts` (`cart_id`) ON DELETE CASCADE,
  CONSTRAINT `cartitems_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`),
  CONSTRAINT `carts_items_chk_1` CHECK ((`quantity` > 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_items` (
  ...
  KEY `orderitems_order` (`order_id`),
  KEY `orderitems_product` (`product_id`),
  CONSTRAINT `orderitems_order` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON DELETE CASCADE,
  CONSTRAINT `orderitems_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`),
...
INSERT INTO `test_users` VALUES (1,'Iqbal'),(2,'Ahmed'),(3,'Student');
...
-- Dump completed on 2026-06-19 12:21:20
